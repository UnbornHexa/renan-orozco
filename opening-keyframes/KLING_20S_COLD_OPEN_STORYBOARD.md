# Kling — First 20s Cold Open (Instrumental → Lyrics)

**Music:** ~150 BPM, first **20s instrumental** before lyrics.  
**Kling:** **3s / ~18 credits** per adjacent-panel gen; trim to beat in edit.  
...
| 16–22s+ | `J`→`04L` | **6s** | Junko surprise→anger→punch shatter→living title→dive Feris phone white. |
